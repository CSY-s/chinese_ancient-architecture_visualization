...
export const featuredSites = [
  {
    ...
    type: '木构宫殿群',
    heat: 98,
    highlight: '高等级木构建筑密集，适合展示监测、修缮与数字化协同保护。',
    tags: ['木构古建筑', '监测点位', '数字建模'],
    detail: {
      title: '故宫博物院保护现状',
      subtitle: '大型宫殿建筑群的预防性保护样本',
      summary: '故宫适合用来展示古建筑保护中的日常监测、屋面病害巡查、三维建模建档和分级修缮策略。',
      tags: ['木构', '宫殿建筑', '监测维护'],
      facts: [
        { label: '保存状态', value: '整体完好，重点部位持续监测' },
        { label: '主要病害', value: '木构变形、彩画老化、屋面渗漏' },
        { label: '数字化工作', value: '三维扫描、档案建模、重点点位监测' }
      ],
      highlights: [
        '大型木构建筑群的保护核心不是一次性修完，而是持续监测与阶段性干预。',
        '数字化模型可用于病害比对、风险复核和修缮方案校核。'
      ]
    }
  },
  {
